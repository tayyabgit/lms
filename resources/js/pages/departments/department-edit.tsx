      ...
      <CommonPageLayout
        header={
          <>
            ...
            <h2 className="text-2xl font-semibold mb-2 text-left">Edit Department</h2>
            <hr className="mb-6" />
          </>
        }
      >
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <div className="grid gap-2">
              ...
              >
                ...
                {teachers.map((teacher) => (
                  <option key={teacher.id} value={teacher.id}>{teacher.id}</option>
                ))}
              </select>
            ...
            <div className="grid gap-2 md:col-span-2">
              ...
              <textarea
                ...
                className="border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-blue-400 px-3 py-2 min-h-[80px]"
              />
