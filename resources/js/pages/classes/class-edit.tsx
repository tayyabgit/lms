...
export default function ClassEdit({ class: classItem, teachers, departments }: ClassEditProps) {
    const { data, setData, put, processing, errors } = useForm<ClassForm>({
        name: classItem.name,
        section: classItem.section ?? '',
        class_teacher_id: classItem.class_teacher_id ? String(classItem.class_teacher_id) : '',
        department_id: classItem.department_id ? String(classItem.department_id) : '',
    });

    const breadcrumbs: BreadcrumbItem[] = [
        { title: 'Classes', href: '/classes' },
        { title: 'Edit Class', href: `/classes/${classItem.id}/edit` },
    ];
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs} title="Edit Class">
